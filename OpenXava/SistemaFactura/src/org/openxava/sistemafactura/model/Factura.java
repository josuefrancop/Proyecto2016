...
public class Factura extends Identifiable {
	...
	@ListProperties("product.number, product.description, unitPrice, quantity, amount[factura.sum, factura.vat, factura.total]")
	private List<FacturaDetalle> details;
	...
	public BigDecimal getSum() {
		...
		for (FacturaDetalle detail: details) {
	...
	public List<FacturaDetalle> getDetails() {
		return details;
	}

	public void setDetails(List<FacturaDetalle> details) {
